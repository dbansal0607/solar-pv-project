...
plt.tight_layout()
plt.savefig(
    "models/visualizations/01_target_distribution.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/02_feature_distributions.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/03_correlation_heatmap.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
target_correlations = (
    correlation_matrix["Power_Output_W"]
    .drop("Power_Output_W")
...
pairplot_data = df[top_features].sample(
...
pairplot = sns.pairplot(
    pairplot_data,
    diag_kind="kde",
    plot_kws={"alpha": 0.6, "s": 30, "color": "#FFD700"},
    diag_kws={"color": "#FFA500"},
)
pairplot.fig.suptitle(
    "Pairplot of Top 3 Features vs Power Output", y=1.02, fontsize=14, fontweight="bold"
)
plt.savefig(
    "models/visualizations/04_pairplot_top_features.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/05_feature_vs_target.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/06_residual_analysis.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/07_predicted_vs_actual.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.axvline(
    ...
    linestyle="--",
    linewidth=2,
    label=f'MAE = {test_metrics["mae"]:.2f}',
)
plt.legend()
plt.grid(True, alpha=0.3)
...
plt.axvline(
    ...
    linestyle="--",
    linewidth=2,
    label=f'MAPE = {test_metrics["mape"]:.2f}%',
)
plt.legend()
plt.grid(True, alpha=0.3)
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/08_error_distribution.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    "models/visualizations/09_feature_importance.png", dpi=300, bbox_inches="tight"
)
plt.close()
...
metrics_data = {
    ...
    "correlation_with_target": {
        feature: round(target_correlations[feature], 4) for feature in FEATURES
    },
